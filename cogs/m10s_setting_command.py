    ...
    async def _setting_command(self, ctx):
        try:
            ...
            settings=[
                ...
                ["グローバルチャット-1","他のサーバーとチャンネルをつなぎ、みんなで話しましょう！","必要引数","`(なし)`/`[グローバルチャットチャンネル名]`","gconnect"],

                ["グローバルチャット-2","何らかの事情で不要になりましたか？切断してみましょう！","必要引数","`(なし)`","gdconnect"],
                ...
                ["役職パネル機能、はじめました","思惟奈ちゃんを使って、好きな絵文字で役職を付与できるパネルを製作しましょう！","必要引数","`(なし)/[create]`/`[delete] [パネルID]`/`[add] [パネルID] [絵文字] [役職が特定できるもの]`/`[remove] [パネルID] [絵文字]`"],
